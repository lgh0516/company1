...
class CompanyInfo(models.Model):
    """公司基本信息"""
    name = models.CharField(verbose_name='公司', max_length=50)  # 在生成数据表时，会创建名为name的字段，字符串类型，长度为50
    ...
    web = models.CharField(verbose_name='公司官网', max_length=200)

    class Meta:  # 元类，可定义该模块的基本信息
        verbose_name = '公司信息'    # 名称
